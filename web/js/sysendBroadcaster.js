 ...
 *  
 *  This has cross-origin and window support in it, which may be the most powerful.  Implementation requires proxy.html
 *  Doesn't seem to need window parent-child relationship is tricky, and opening a new window or window in another browser doesnt work.
 *  Little Firefox tick that may require we open CORS through web server for certain (or all) pages.  
 *
 */
